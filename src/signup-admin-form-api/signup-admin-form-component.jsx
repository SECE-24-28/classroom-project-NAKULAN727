...
const SignupFormAdminComponent = () => {
  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      const pushDetails = await axios.post(
        "http://localhost:22000/api/v1/Admin/adminSignup",
        {
  ...
  const getDetailsFunction = async () => {
    try {
      const getDetails = await axios.get(
        "http://localhost:22000/api/v1/Admin/getAdmins"
      );
...
export default SignupFormAdminComponent;
